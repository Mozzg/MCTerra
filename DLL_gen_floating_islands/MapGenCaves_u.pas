...
type MapGenCaves=class(MapGenBase)
     public
       procedure generateLargeCaveNode(l:int64; i,j:integer; abyte0:ar_byte; d,d1,d2:double);
       procedure generateCaveNode(l:int64; i,j:integer; abyte0:ar_byte; d,d1,d2,f,f1,f2:double; k,i1:integer; d3:double);
...
procedure MapGenCaves.generateLargeCaveNode(l:int64; i,j:integer; abyte0:ar_byte; d,d1,d2:double);
begin
  generateCaveNode(l, i, j, abyte0, d, d1, d2, 1 + rand.nextFloat() * 6, 0, 0, -1, -1, 0.5);
end;

procedure MapGenCaves.generateCaveNode(l:int64; i,j:integer; abyte0:ar_byte; d,d1,d2,f,f1,f2:double; k,i1:integer; d3:double);
var d4,d5,f3,f4,d6,d7,f5,f6,d8a,d9a,d10a,d11,d12,d13,d14:double;
random1:rnd;
  ...
  begin
    ...
    begin
      ...
      begin
        if flag2=true then break;
        j3:=i2+1;
        while (flag2=false)and(j3 >= d9 - 1) do     //Y
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                if (flag3)and(abyte0[i4 - 256] = 3)then
                  //abyte0[i4 - 256]:=manager.getBiomeGenAt(l2 + i * 16, l3 + j * 16).topBlock;
                  abyte0[i4 - 256+10240]:=0;  //somnitel'no
              end;
            end;
          end;
          //dec(i4);
...
procedure MapGenCaves.recursiveGenerate(sid:int64; i,j,k,l:integer; abyte0:ar_byte);
...
begin
  ...
  begin
    ...
    d1:=rand.nextInt(rand.nextInt(128 - 8) + 8);      //WORLDHEIGHT
