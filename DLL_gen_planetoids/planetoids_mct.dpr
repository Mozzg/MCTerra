library planetoids_mct;

{$DESCRIPTION 'Planetoids generator plugin for MCTerra'}
...
begin
  ...
  plugin_settings.full_name:='Planetoids gen. for MCTerra';
  plugin_settings.name:='Planetoids';
