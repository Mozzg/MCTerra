...
var l,i1,i2,l2,byte0,j3,j1,k1,j2,i3,k3,l3,i4,j4,l1,k2:integer;
flag:boolean;
begin
  l:=rand.nextInt(3) + 5;
  flag:=true;
    ...
    begin
      ...
      begin
        ...
        if (((abs(l3) <> i3)or(abs(j4) <> i3)or(rand.nextInt(2) <> 0)and(j2 <> 0))and(get_block_id(map,xreg,yreg,k3, k1, i4)in trans_bl))then
          set_block_id_data(map,xreg,yreg, k3, k1, i4, 18, 2);
      end;
    end;
  end;
  ...
  begin
    ...
    if (k2 = 0)or(k2 = 18)then
      set_block_id_data(map,xreg,yreg, i, j + l1, k, 17, 2);   
  end;
