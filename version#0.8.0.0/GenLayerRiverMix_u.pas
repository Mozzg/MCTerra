...
type  GenLayerRiverMix=class(GenLayer)
      ...
      public
        ...
        procedure func_35496_b(l:int64); override;
...
procedure GenLayerRiverMix.func_35496_b(l:int64);
begin
  field_35512_b.func_35496_b(l);
  field_35513_c.func_35496_b(l);
  inherited func_35496_b(l);
end;

function GenLayerRiverMix.func_35500_a(i,j,k,l:integer):ar_int;
var ai,ai1:ar_int;
ai2:par_int;
i1:integer;
begin
  ai:=field_35512_b.func_35500_a(i, j, k, l);
  ai1:=field_35513_c.func_35500_a(i, j, k, l);
