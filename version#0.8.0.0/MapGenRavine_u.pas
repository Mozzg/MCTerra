...
uses MapGenBase_u, generation_obsh, WorldChunkManager_u, NBT;

type  MapGenRavine=class(MapGenBase)
      private
        field_35627_a:ar_double;
      protected
        procedure func_35626_a(l:int64; i,j:integer; abyte0:ar_type; d,d1,d2,f,f1,f2:extended; k,i1:integer; d3:extended);
...
procedure MapGenRavine.func_35626_a(l:int64; i,j:integer; abyte0:ar_type; d,d1,d2,f,f1,f2:extended; k,i1:integer; d3:extended);
var random1:rnd;
d4,d5,f3,f4,f5,d6,d7,f6,f7,d8a,d9a,d10a,d11,d12,d13,d14:extended;
j1,k1,d8,d9,d10,l1,i2,j2,k2,l2,i3,j3,k3,l3,i4,j4:integer;
byte0:byte;
...
begin
  ...
  begin
    ...
    d10a:= i1 - k;
    d11:= f + 2 + 16;
    if(((d8a * d8a + d9a * d9a) - d10a * d10a) > (d11 * d11)) then exit;
    ...
    begin
      ...
      begin
        if flag1=true then break;
        j3:=i2+1;
        //for j3:=i2+1 to d9-1 do
        while (flag1=false)and(j3>=d9-1) do
        begin
          //if flag1=true then break;
          k3:=(k2 * 16 + i3) * 128 + j3;
          ...
          if(abyte0[k3]=9)or(abyte0[k3]=8) then flag1:=true;
        ...
        repeat
          ...
          begin
            ...
            begin
              ...
              begin
                abyte0[i4]:= 0;
                if(flag2)and(abyte0[i4 - 1]=3) then
...
procedure MapGenRavine.recursiveGenerate(i,j,k,l:integer; abyte0:ar_type);
var d,d1,d2,f,f1,f2:extended;
begin
